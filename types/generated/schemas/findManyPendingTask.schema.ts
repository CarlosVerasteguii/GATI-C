...
export const PendingTaskFindManySelectSchema: z.ZodType<Prisma.PendingTaskSelect> = z.object({
...
export const PendingTaskFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    creatorId: z.boolean().optional(),
    type: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const PendingTaskFindManySchema: z.ZodType<Prisma.PendingTaskFindManyArgs> = z.object({ select: PendingTaskFindManySelectSchema.optional(), include: z.lazy(() => PendingTaskIncludeObjectSchema.optional()), orderBy: z.union([PendingTaskOrderByWithRelationInputObjectSchema, PendingTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: PendingTaskWhereInputObjectSchema.optional(), cursor: PendingTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PendingTaskScalarFieldEnumSchema, PendingTaskScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PendingTaskFindManyArgs>;

export const PendingTaskFindManyZodSchema = z.object({ select: PendingTaskFindManySelectSchema.optional(), include: z.lazy(() => PendingTaskIncludeObjectSchema.optional()), orderBy: z.union([PendingTaskOrderByWithRelationInputObjectSchema, PendingTaskOrderByWithRelationInputObjectSchema.array()]).optional(), where: PendingTaskWhereInputObjectSchema.optional(), cursor: PendingTaskWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PendingTaskScalarFieldEnumSchema, PendingTaskScalarFieldEnumSchema.array()]).optional() }).strict();