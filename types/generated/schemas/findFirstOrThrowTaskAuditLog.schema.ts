...
export const TaskAuditLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaskAuditLogSelect> = z.object({
...
export const TaskAuditLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    taskId: z.boolean().optional(),
    userId: z.boolean().optional(),
    event: z.boolean().optional(),
...
export const TaskAuditLogFindFirstOrThrowSchema: z.ZodType<Prisma.TaskAuditLogFindFirstOrThrowArgs> = z.object({ select: TaskAuditLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TaskAuditLogIncludeObjectSchema.optional()), orderBy: z.union([TaskAuditLogOrderByWithRelationInputObjectSchema, TaskAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskAuditLogWhereInputObjectSchema.optional(), cursor: TaskAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskAuditLogScalarFieldEnumSchema, TaskAuditLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaskAuditLogFindFirstOrThrowArgs>;

export const TaskAuditLogFindFirstOrThrowZodSchema = z.object({ select: TaskAuditLogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TaskAuditLogIncludeObjectSchema.optional()), orderBy: z.union([TaskAuditLogOrderByWithRelationInputObjectSchema, TaskAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaskAuditLogWhereInputObjectSchema.optional(), cursor: TaskAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskAuditLogScalarFieldEnumSchema, TaskAuditLogScalarFieldEnumSchema.array()]).optional() }).strict();